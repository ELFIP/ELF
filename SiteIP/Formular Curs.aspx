...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="head">
    <link rel='stylesheet' type='text/css' href="/Resources/css/formularCursStyle.css" />
...
<asp:Content runat="server" ID="content" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Table ID="formular" runat="server" Width="80%" Style="margin-left: 10%">
        <asp:TableHeaderRow Width="100%">
            <asp:TableHeaderCell HorizontalAlign="Center" Style="padding: 10px" Width="20%" CssClass="th-image">
                ...
                <hr />
                <asp:Button ID="btnUpload" runat="server"  Text="Upload" OnClick="Upload" CssClass="buton-sec" />
            </asp:TableHeaderCell>
        ...
        <asp:TableRow Width="100%">
            <asp:TableCell HorizontalAlign="Center" Style="padding: 10px" ColumnSpan="2">
                <asp:Button ID="AdaugaCurs" runat="server" Text="Adauga Curs" HorizontalAlign="Center" OnClick="adauga_curs_Click" CssClass="buton" />
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Content>
