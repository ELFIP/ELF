        ...
        <asp:Panel ID="formular" runat="server" CssClass="formular_facultate">
            ...
            <div class="input_form_container">
                ...
                <div class="inputBoxContainers">
                    ...
                    <asp:TextBox ID="adresa_facultatii" placeholder="Ion Calin, nr 9.." runat="server" CssClass="adresa_facultate_formular"></asp:TextBox>
                     </div>
            
                <div class="inputBoxContainers">
                    <asp:Label AssociatedControlID="alte_informatii" runat="server" CssClass="form_labels" Text="Alte Info." ></asp:Label>
                    <asp:TextBox ID="alte_informatii" placeholder="Banane.." runat="server" CssClass="alte_informatii_formular">
                    </asp:TextBox>
                     </div>
                <div class="inputBoxContainers">
