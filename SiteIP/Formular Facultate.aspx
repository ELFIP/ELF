        ...
        <asp:Panel ID="formular" runat="server" CssClass="formular_facultate">
            ...
            <div class="input_form_container">
                <div class="inputBoxContainers">
                    ...
                    <asp:TextBox ID="nume_facultate" runat="server" placeholder="Facultate" CssClass="nume_facultate_formular"></asp:TextBox>
                </div>
                <div class="inputBoxContainers">
                    <asp:Label AssociatedControlID="localitatea_facultatii" runat="server" CssClass="form_labels" Text="Localitate" ></asp:Label>
                    <asp:TextBox ID="localitatea_facultatii" runat="server" placeholder="Localitate" CssClass="localitate_facultate_formular"></asp:TextBox>
                </div>
                <div class="inputBoxContainers">
                    <asp:Label AssociatedControlID="adresa_facultatii" runat="server" CssClass="form_labels" Text="Adresa" ></asp:Label>
                    <asp:TextBox ID="adresa_facultatii" TextMode="MultiLine" Rows="3"  placeholder="Adresa" runat="server" CssClass="adresa_facultate_formular"></asp:TextBox>
                </div>
                <div class="inputBoxContainers">
