...
public partial class Music_Production_administrator : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
             Response.Redirect("Music Production.aspx");
        }
        culegeDate();
        selecteazaIdCurs();
    ...
    protected void stergeVideoclip(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Music Production_administrator.aspx");
    }
