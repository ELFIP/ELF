...
public partial class Testul_1 : System.Web.UI.Page
{
    ...
    List<string> intrebari = new List<string>  { "Miscarea sunetului printr-un mediu se numeste:", "\"Viteza sunetului\" se refera la:", "Viteza sunetului poate fi afectata de (bifati toate care se aplica):", "O modalitate buna de a va aminti viteza sunetului este (bifati):", "Momentul exact al sunetului are un impact direct asupra:", "Care categorie de efecte se refera la propagarea sunetului?" };
    List<List<string>> raspunsuri = new List<List<string>>  { new List<string> {  "amplitudine", "propagare", "spectru", "frecventa" },  new List<string> {  "  Cat de repede se misca sunetul prin apa", "  Cat de repede se misca sunet in vid ", "  Cat de repede se misca sunetul prin aer", "  Efectul Doppler" },  new List<string> {  "temperatura", "inaltime", "  Mediul prin care sunetul circula" },  new List<string> {  "  O mila in cinci secunde", "  Un picior pe milisecunda", "  340 de metri pe secunda", "  Un kilometru in trei secunde" },  new List<string> {  "  Locatia sunetul in cadrul spatiului", "  Spectrul sunetului", "  Amplitudinea sunetului" },  new List<string> {  "  efecte de filtru", "  efecte de intarziere", "  efecte dinamice", "  efecte de distorsiune" }  } ;
    List<List<bool>> raspunsuri_corecte = new List<List<bool>>  { new List<bool> {  true, false, false, false },  new List<bool> {  false, false, true, false },  new List<bool> {  true, false, true },  new List<bool> {  false, false, false, true },  new List<bool> {  false, true, false },  new List<bool> {  false, false, true, false }  } ;
