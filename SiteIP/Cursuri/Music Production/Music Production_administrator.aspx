<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Music Production_administrator.aspx.cs" Inherits="Music_Production_administrator" MasterPageFile="~/MasterPage.master" %>
   ...
   <asp:Table ID="forma" runat="server" Width="80%" Style="margin-left: 10%">
       <asp:TableHeaderRow >
           <asp:TableHeaderCell HorizontalAlign="Center" Style="padding: 10px">
               <asp:Image ID="imagine_curs" runat="server" ImageUrl="~/Imagini_cursuri/Music Production.jpg" Width="100px" Height="100px"/>
               <asp:Label ID="numeCurs" runat="server" Text="Music Production" Width="50%"></asp:Label>
           </asp:TableHeaderCell>
            <asp:TableHeaderCell HorizontalAlign="Center" Style="padding: 10px">
       ...
       <asp:TableRow>
           <asp:TableCell HorizontalAlign="Center" Style="padding: 10px">
               <asp:Label ID="despreCurs" TextMode="MultiLine" Rows="10" runat="server" Text="Introduction to Music Production">
               </asp:Label>
           </asp:TableCell>
       </asp:TableRow>
       <asp:TableRow>
       ...
       <asp:TableRow>
           <asp:TableCell HorizontalAlign="Center" Style="padding: 10px">
                <asp:HyperLink ID="hyperlink_adaugaReferinta" NavigateUrl="~/Formular Referinte Curs.aspx?nume_curs=Music Production" runat="server">Adauga Referinta</asp:HyperLink>
           </asp:TableCell>
       </asp:TableRow>
   </asp:Table>
</asp:Content>
