...
public partial class Interactive_Programming_in_Python_administrator : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
             Response.Redirect("Interactive Programming in Python.aspx");
        }
        culegeDate();
        selecteazaIdCurs();
    ...
    protected void stergeVideoclip(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Interactive Programming in Python_administrator.aspx");
    }
