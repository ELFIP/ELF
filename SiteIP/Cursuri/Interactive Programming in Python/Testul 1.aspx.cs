...
public partial class Testul_1 : System.Web.UI.Page
{
    ...
    List<string> intrebari = new List<string>  { "Care din urmatoarele siruri de caractere sunt corecte sintactic?", "Care din urmatoarele expresii aritmetice sunt corecte sintactic?", "V-ati dori sa faceti In aaa fel Incat variabila ounces sa aibe valoarea de 16, reprezentand astfel o lira. Ce declaratie simpla In Python va realiza aceasta?", "Un gram este egal cu 0.035274 ounces. Sa presupunem ca variabila mass_in_ounces are o valoare reprezentand o masa In ounces. Care expresii aritmetice folosesc variabila mass_in_ounces reprezintand masa echivalenta In grame?", "Care din urmatoarele poate fi folosite ca un nume de variabila?", "Sa presupunem ca avem valori In variabile x ai y. Care afirmatie(afirmatii) ar conduce la X care sa aibe suma valorilor curente ale lui x ai y?" };
    List<List<string>> raspunsuri = new List<List<string>>  { new List<string> {  "'Hello' ", "\"Hello\" ", "Hello ", "\"Hello", "\"It's a beautiful day.\" " },  new List<string> {  "5 - 1 - 3 - 7 - 0 ", "3 * ((2 - 9) + 4)) * (2 + (1 - 3)) ", "9 + * 4 ", "7 / +4 ", "(8 + (1 + (2 * 4) - 3)) " },  new List<string> {  "16 = ounces ", "ounces == 16 ", "ounces = 16 " },  new List<string> {  "mass_in_ounces * 0.035274 ", "mass_in_ounces / 0.035274 ", "0.035274 / mass_in_ounces ", "0.035274 * mass_in_ounces " },  new List<string> {  "16ounces ", "my_number ", "number123 ", "ounce(s) ", "__number__", "ounces " },  new List<string> {  "x = x + y ", "x = y + x ", "x += y + x ", "x += x + y " }  } ;
    List<List<bool>> raspunsuri_corecte = new List<List<bool>>  { new List<bool> {  false, true, false, false, true },  new List<bool> {  true, true, false, false, true },  new List<bool> {  false, false, true },  new List<bool> {  true, false, false, false },  new List<bool> {  false, true, true, false, false, true },  new List<bool> {  true, true, false, false }  } ;
