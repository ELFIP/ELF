<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fundamentals of Project Planning and Management_administrator.aspx.cs" Inherits="Fundamentals_of_Project_Planning_and_Management_administrator" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content runat="server" ID="content" ContentPlaceHolderID="ContentPlaceHolder1">
   <asp:Table ID="forma" runat="server" Width="80%" Style="margin-left: 10%">
       ...
       <asp:TableRow>
           <asp:TableCell HorizontalAlign="Center" Style="padding: 10px">
                <asp:HyperLink ID="hyperlink_adaugaReferinta" NavigateUrl="~/Formular Referinte Curs.aspx?nume_curs=Fundamentals of Project Planning and Management" runat="server">Adauga Referinta</asp:HyperLink>
           </asp:TableCell>
       </asp:TableRow>
   </asp:Table>
</asp:Content>
