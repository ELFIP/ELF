<%@ Page Language="C#" AutoEventWireup="true" CodeFile="testtest.aspx.cs" Inherits="testtest" MasterPageFile="~/MasterPage.master"%>
       ...
       <asp:Table ID="formular" runat="server" Width="80%" style="margin-left: 10%">
            <asp:TableHeaderRow Width="100%">
                <asp:TableHeaderCell HorizontalAlign="Center" style="padding:10px" Width="50%">
                    <asp:Label ID="numeTest" runat="server" Text="testtest" Width="50%">
                    </asp:Label>
                </asp:TableHeaderCell>
                <asp:TableHeaderCell HorizontalAlign="Center" style="padding:10px" Width="50%">
