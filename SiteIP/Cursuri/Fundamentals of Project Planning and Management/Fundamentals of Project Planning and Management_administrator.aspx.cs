...
public partial class Fundamentals_of_Project_Planning_and_Management_administrator : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
             Response.Redirect("Fundamentals of Project Planning and Management.aspx");
        }
        culegeDate();
        selecteazaIdCurs();
    ...
    protected void stergeVideoclip(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Fundamentals of Project Planning and Management_administrator.aspx");
    }
