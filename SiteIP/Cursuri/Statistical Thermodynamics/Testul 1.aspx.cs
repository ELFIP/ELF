...
public partial class Testul_1 : System.Web.UI.Page
{
    ...
    List<string> intrebari = new List<string>  { "In formularea Lagrange din mecanica clasica, cum este definita aceasta?", "In formularea Hamiltoniana din mecanica, cum se defineste aceasta?", "Sa consideram ca sistemul are: o dimensiune, V si entropia S. Acum, cand dimensiunea unui sistem termodinamic V este dublat, cum este entropia sistemului corespunzatoare?", "Care dintre aceste variabile termodinamice sunt intensive, adica nu depind de dimensiunea sistemului? ", "Ce este conjugatul intensiv al variabilei entropiei  S?" };
    List<List<string>> raspunsuri = new List<List<string>>  { new List<string> {  " T−V", "VT", "V-T", "T+V", "V" },  new List<string> {  "V-T", "V", "T+V", "T-V", "T" },  new List<string> {  "S", "4S", "S2", "S+1", "2S" },  new List<string> {  "  Energie Interna", "  Numarul de particule", "Presiunea", "Temperatura", "Entropia" },  new List<string> {  "Numarul de particule", "Presiunea", "Energia interna", "Temperatura", "Volumul" }  } ;
    List<List<bool>> raspunsuri_corecte = new List<List<bool>>  { new List<bool> {  false, false, true, false, false },  new List<bool> {  false, false, true, false, false },  new List<bool> {  false, false, true, false, false },  new List<bool> {  false, false, true, false, false },  new List<bool> {  true, false, false, false, false }  } ;
