<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rethinking International Tax Law_administrator.aspx.cs" Inherits="Rethinking_International_Tax_Law_administrator" MasterPageFile="~/MasterPage.master" %>
   ...
   <asp:Table ID="forma" runat="server" Width="80%" Style="margin-left: 10%">
       <asp:TableHeaderRow >
           <asp:TableHeaderCell HorizontalAlign="Center" Style="padding: 10px">
               <asp:Image ID="imagine_curs" runat="server" ImageUrl="~/Imagini_cursuri/Rethinking International Tax Law.jpg" Width="100px" Height="100px"/>
               <asp:Label ID="numeCurs" runat="server" Text="Rethinking International Tax Law" Width="50%"></asp:Label>
           </asp:TableHeaderCell>
            <asp:TableHeaderCell HorizontalAlign="Center" Style="padding: 10px">
       ...
       <asp:TableRow>
           <asp:TableCell HorizontalAlign="Center" Style="padding: 10px">
               <asp:Label ID="despreCurs" TextMode="MultiLine" Rows="10" runat="server" Text="Rethinking International Tax Law">
               </asp:Label>
           </asp:TableCell>
       </asp:TableRow>
       <asp:TableRow>
       ...
       <asp:TableRow>
           <asp:TableCell HorizontalAlign="Center" Style="padding: 10px">
                <asp:HyperLink ID="hyperlink_adaugaReferinta" NavigateUrl="~/Formular Referinte Curs.aspx?nume_curs=Rethinking International Tax Law" runat="server">Adauga Referinta</asp:HyperLink>
           </asp:TableCell>
       </asp:TableRow>
   </asp:Table>
</asp:Content>
