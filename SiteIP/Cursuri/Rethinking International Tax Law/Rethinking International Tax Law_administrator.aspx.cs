...
public partial class Rethinking_International_Tax_Law_administrator : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
             Response.Redirect("Rethinking International Tax Law.aspx");
        }
        culegeDate();
        selecteazaIdCurs();
    ...
    protected void stergeVideoclip(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Rethinking International Tax Law_administrator.aspx");
    }
