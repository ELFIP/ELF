...
public partial class Testul_1 : System.Web.UI.Page
{
    ...
    List<string> intrebari = new List<string>  { "Deteriorarea maduva spinarii ar cauza afectarea carora dintre urmatoarele functii?", "Deteriorari cauzate de deprecierea trunchiului cerebral ar cauza afectarea carora dintre urmatoarele functii?", "Deteriorari cauzate de deprecierea forebrain ar cauza afectarea carora dintre  urmatoarele functii?", "Care dintre urmatoarele situatii se regasesc in scleroza multipla? Alege un raspuns.", "Care dintre urmatoarele sunt in interiorul stratului arahnoid?", "In cadrul unui neuron, in ce directie circula fluxurile de informatii? Alege toate care se potrivesc:", "Intre doi neuroni, fluxurile de informatii circula in directia? Alege un raspuns.", "Motoneuronii sunt celule foarte speciale. Care dintre urmatoarele sunt adevarate? Selectati toate care se aplica.", "Care dintre urmatoarele sunt adevarate despre mielina? Selectati toate care se aplica.", "O tumoare intracraniana este cel mai putin probabil sa fie format din tipul de celule? Alegeti un raspuns", "Toxinele si virusi sunt molecule mari care patrund in corp prin care tesutul bariera cum ar fi pielea, plamanii sau intestinele. Dar ei nu au acces gratuit la sistemul nervos central. Pe care dintre urmatoarele rute ar putea calatori o toxina sau un virus pentru a ajunge la SNC?" };
    List<List<string>> raspunsuri = new List<List<string>>  { new List<string> {  " Miscarea voluntara a bratelor si picioarelor", "Cititul", "Auzul", "Homeostazia", "Memoria" },  new List<string> {  " Miscarea voluntara a bratelor si picioarelor", "Vorbirea", "Auzul", "Homeostazia", "Memoria" },  new List<string> {  " Miscarea voluntara a bratelor si picioarelor", "Vorbirea", "Auzul", "Homeostazia", "Memoria" },  new List<string> {  " Moartea neuronilor centrali", " Moartea neuronilor periferici", " Demielinizarea centrala a axonilor", " Demielinizarea axonilor periferice", " Nici una dintre cele de mai sus" },  new List<string> {  "Dura", "Pia", "Motoneuronii", " Neuronii senzoriali periferici", " Neuronii din talamus" },  new List<string> {  " De la dendrite la celulele din corp", " Din corp la celule axonilor", " De la axon la dendrite", " De la axon la celulele din corp", " Din axon la un terminal sinaptic" },  new List<string> {  " Din terminalul sinaptic al unei celule la axonul alteia", " Din axonul unei celule la terminalul sinaptic", " Din dendrita unei celule la terminalul sinaptic", " Din terminalul sinaptic al unei celule la dendrita", " Nici una dintre cele de mai sus" },  new List<string> {  " Au un axon care paraseste sistemul nervos central", " Inerveaza muschii voluntari precum bicepsul sau cvadricepsul", " Sunt necesare pentru circulatia voluntara", " Au dendritele", " Primesc intrari sinaptice" },  new List<string> {  " Acesta acopera toti axonii din sistemul nervos central", " Acesta acopera doar anumiti axoni din sistemul nervos periferic", " Aceasta cresc viteza de la care potentiale de actiune calatoresc in unii axoni si scad in altii", " Pierderea mielina va creste viteza de conducere a potentialului de actiune", " Nici una dintre cele de mai sus" },  new List<string> {  " Celulele pulmonare", " Celulele Arachnoid", " Celulele pituitare", " Astrocitele", "Neuronii" },  new List<string> {  " O toxina sau virus ar putea calatori prin fluxul de sange pentru a intra SNC", " O toxina sau un virus infecteaza direct neuronul central", " O toxina sau virus ar putea fi transportate catre un neuron periferic in SNC", " O toxina sau un virus ar putea trece de pia", " O toxina sau un virus ar putea trece de dura" }  } ;
    List<List<bool>> raspunsuri_corecte = new List<List<bool>>  { new List<bool> {  false, true, false, false, false },  new List<bool> {  false, true, false, false, false },  new List<bool> {  false, true, false, false, false },  new List<bool> {  false, true, false, false, false },  new List<bool> {  false, true, true, false, false },  new List<bool> {  true, false, true, false, false },  new List<bool> {  false, true, false, false, false },  new List<bool> {  true, true, false, false, false },  new List<bool> {  false, false, false, false, true },  new List<bool> {  true, false, false, false, false },  new List<bool> {  true, false, false, false, false }  } ;
