...
public partial class Inspiring_Leadership_through_Emotional_Intelligence_administrator : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
             Response.Redirect("Inspiring Leadership through Emotional Intelligence.aspx");
        }
        culegeDate();
        selecteazaIdCurs();
    ...
    protected void stergeVideoclip(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Inspiring Leadership through Emotional Intelligence_administrator.aspx");
    }
