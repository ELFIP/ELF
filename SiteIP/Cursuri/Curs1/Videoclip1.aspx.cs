...
public partial class Videoclip1 : System.Web.UI.Page
{
    ...
    private void adaugaInBazaDeDate()
    {
        ...
        comanda.Connection = conexiune;
        comanda.Connection.Open();
        comanda.CommandText = "Insert into [Utilizator_Videoclip] values (" + id_utilizator + ", " + id_videoclip + ",  CONVERT(VARCHAR(10), GETDATE(), 10), " + 0 + ");";
