<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Videoclip1.aspx.cs" Inherits="Videoclip1" MasterPageFile="~/MasterPage.master"%>
       ...
       <asp:Table ID="formular" runat="server" Width="80%" style="margin-left: 10%">
            <asp:TableHeaderRow Width="100%">
                <asp:TableHeaderCell HorizontalAlign="Center" style="padding:10px" Width="50%">
                    <asp:Label ID="numeVideoclip" runat="server" Text="Videoclip1" Width="50%">
                    </asp:Label>
                </asp:TableHeaderCell>
                <asp:TableHeaderCell HorizontalAlign="Center" style="padding:10px" Width="50%">
                    <asp:Label ID="numeCurs" runat="server" Text="Curs1" Width="50%">
                    </asp:Label>
                </asp:TableHeaderCell>
            </asp:TableHeaderRow>
           <asp:TableRow>
               <asp:TableCell HorizontalAlign="Center" ColumnSpan="2">
                   <iframe ID="afiseaza" width="560" height="315" src="Videoclip1.jpg" frameborder="0" allowfullscreen runat="server"></iframe>
               </asp:TableCell>
           </asp:TableRow>
           <asp:TableRow>
               <asp:TableCell HorizontalAlign="Center" ColumnSpan="2">
